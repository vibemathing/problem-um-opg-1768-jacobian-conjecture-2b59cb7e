...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-1768-jacobian-conjecture-2b59cb7e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-1768"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-1768-jacobian-conjecture-2b59cb7e-v1",
      "problem_contract_sha256": "2923a96265210eb198cd50137db10601138937e4331e8560e2809247e3d5f8ef",
      "problem_id": "problem:um-opg-1768-jacobian-conjecture-2b59cb7e",
      "route_id": "route:um-opg-1768-jacobian-conjecture-2b59cb7e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-1768-jacobian-conjecture-2b59cb7e-source-fidelity-01",
      "graph_id": "graph:um-opg-1768-jacobian-conjecture-2b59cb7e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-1768-jacobian-conjecture-2b59cb7e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-1768-jacobian-conjecture-2b59cb7e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $k$ be a field of characteristic zero. A collection $f_1,\\ldots,f_n$ of polynomials in variables $x_1,\\ldots,x_n$ defines an automorphism of $k^n$ if and only if the Jacobian matrix is a nonzero constant."
          },
          "statement_sha256": "e806c0ae94d6ac85806bb47276a95c17a2269c9e45f97ecdbaabf074ff5be497"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-1768-jacobian-conjecture-2b59cb7e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-1768-jacobian-conjecture-2b59cb7e-root",
      "route_id": "route:um-opg-1768-jacobian-conjecture-2b59cb7e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-1768-d13eaceb2df9",
        "url": "https://www.unsolvedmath.com/problems/OPG-1768"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
